      ...
      <div className="bg-white">
        <main className="flex justify-between items-start py-16 max-w-7xl mx-auto px-4">
          <div className="max-w-xl mt-16">
            <h1 className="text-6xl mb-12 text-mm-dark">Welcome to<br />Musical Memories</h1>
            <p className="text-xl text-mm-dark mb-12">
              Providing students with an exciting and engaging way to develop their skills in the world of music
            </p>
        ...
        <section ref={sectionRef} className="max-w-7xl mx-auto py-16 px-4">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-4xl font-bold bg-mm-blue inline-block px-4 py-2 rounded-lg">What we do</h2>
            <p className="text-xl text-mm-dark">
              At our nonprofit organization, we offer a range of services to spread the joy of music to the global community.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              { title: "High-quality performances", bg: "bg-mm-blue", img: Performances },
              { title: "Expert workshops", bg: "bg-mm-dark", img: Workshops },
              { title: "Fun competitions", bg: "bg-mm-gray", img: Competitions },
              { title: "Content creation", bg: "bg-mm-blue", img: ContentCreation },
              ...
              >
                ...
                <img src={item.img} alt={item.title} className="h-40 w-40 object-contain" />
              </button>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto py-16 px-4">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-4xl font-bold bg-mm-blue px-4 py-2 rounded-lg">Upcoming Events</h2>
            <p className="text-xl text-mm-dark">What are we up to these days?</p>
          </div>
          
          <div className="bg-mm-dark rounded-3xl p-8">
            <div className="flex justify-between text-white">
              <div className="flex-1 border-r border-gray-600 pr-4">
                <p className="mb-4">[describe kaufman stuff]</p>
                <button className="text-mm-blue flex items-center">
                  Sign up <span className="ml-2">→</span>
                </button>
              </div>
              <div className="flex-1 border-r border-gray-600 px-4">
                <p className="mb-4">[music competition stuff]</p>
                <button className="text-mm-blue flex items-center">
                  Sign up <span className="ml-2">→</span>
                </button>
              </div>
              <div className="flex-1 pl-4">
                <p className="mb-4">[smth here]</p>
                <button className="text-mm-blue flex items-center">
                  Sign up <span className="ml-2">→</span>
                </button>
              </div>
