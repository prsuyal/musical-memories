...
const ContactSection = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto py-8 sm:py-16 px-4">
      ...
      <p className="text-xl text-[#191A23] mb-8">Connect with Us: Let's Discuss Any Questions or Concerns</p>
      ...
      <div className="bg-[#f3f4f6] rounded-3xl p-8 flex flex-col md:flex-row items-start">
        <div className="w-full md:w-2/3 pr-8">
          ...
          >
            ...
            <div className="flex space-x-6 mb-6">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="sr-only"
                />
                <span className={`w-5 h-5 border-2 border-[#191A23] rounded-full inline-block mr-2 relative`}>
                  {purpose === 'say_hi' && (
            ...
            <textarea
              ...
              placeholder={purpose === 'ask_question' ? 'Ask your question here' : 'Say hello to the team'}
              className="w-full p-3 border border-[#191A23] rounded-lg bg-white"
              rows="4"
              required
            ></textarea>
        ...
        <div className="w-full md:w-1/3 mt-8 md:mt-0 flex justify-center">
          <img src={ContactMusicIcon} alt="Music Icon" className="w-full max-w-xs" />
        </div>
      </div>
    </section>
  );
